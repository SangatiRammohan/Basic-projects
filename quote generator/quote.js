let teluguquotes=document.getElementById("Quotes")

let data=[  "ప్రతి సమస్యకూ పరిష్కారం ఉంది. దాన్ని కనిపెట్టడమే మన పని.",
...
function randquotes(){
    ...
    console.log(random)
    teluguquotes.textContent=data[random]
    console.log(teluguquotes.textContent)
}